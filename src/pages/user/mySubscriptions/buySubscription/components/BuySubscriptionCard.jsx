...
const BuySubscriptionCard = ({subscription, setSubscriptionPurchaseDialog, setSubscriptionToBuy}) => {
            ...
            <Card sx={{minWidth: 275, borderRadius: 8, border: '1px solid #e0e0e0'}}>
                ...
                <CardActions sx={{justifyContent: 'center'}}>
                    <Button onClick={() => {
                        ...
                        setSubscriptionPurchaseDialog(true)
                    }}
                            variant="contained"
                            sx={{backgroundColor: '#6573c3', color: 'white'}}
                    >Purchase<Shop/>
                    </Button>
                </CardActions>
            </Card>
